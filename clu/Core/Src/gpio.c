...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(TMP_LED_OUTPUT_GPIO_Port, TMP_LED_OUTPUT_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = TMP_LED_OUTPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(TMP_LED_OUTPUT_GPIO_Port, &GPIO_InitStruct);
