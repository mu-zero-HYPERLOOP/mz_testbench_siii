...
private:
	...
	ICM20602 m_imu1{imuConfig, &hspi2, CS_IMU1_GPIO_Port, CS_IMU1_Pin};
	ICM20602 m_imu2{imuConfig, &hspi2, CS_IMU2_GPIO_Port, CS_IMU2_Pin};
	ICM20602 m_imu3{imuConfig, &hspi2, CS_IMU3_GPIO_Port, CS_IMU3_Pin};
