...
#define CANZERO_TX_PDO1_CAN_ID        0x181
#define CANZERO_RX_PDO1_CAN_ID        0x1C1
#define CANZERO_TX_PDO2_CAN_ID        0x201
#define CANZERO_RX_PDO2_CAN_ID        0x241
#define CANZERO_TX_PDO3_CAN_ID        0x281
#define CANZERO_RX_PDO3_CAN_ID        0x2C1
#define CANZERO_TX_PDO4_CAN_ID        0x301
#define CANZERO_RX_PDO4_CAN_ID        0x341
#define CANZERO_TX_PDO5_CAN_ID        0x381
#define CANZERO_TX_PDO6_CAN_ID        0x3C1
#define CANZERO_TX_PDO7_CAN_ID        0x401
#define CANZERO_TX_PDO8_CAN_ID        0x441
#define CANZERO_TX_PDO9_CAN_ID        0x481
#define CANZERO_TX_PDO10_CAN_ID       0x4C1
#define CANZERO_TX_PDO11_CAN_ID       0x501
#define CANZERO_TX_PDO12_CAN_ID       0x541
#define CANZERO_SDO_RESP_CAN_ID       0x581
#define CANZERO_SDO_REQ_UP_CAN_ID     0x5C1
#define CANZERO_SDO_REQ_DOWN_CAN_ID   0x601
#define CANZERO_HEARTBEAT_CAN_ID      0x701
#define CANZERO_BTL_TX_CAN_ID         0x741
#define CANZERO_BTL_RX_CAN_ID         0x781
