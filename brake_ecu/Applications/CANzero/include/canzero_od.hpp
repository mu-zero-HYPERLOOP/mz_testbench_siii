...
extern volatile float    OD_IntakePressure;
extern volatile float    OD_OuttakePressure;
...
extern osMutexId_t mutex_OD_IntakePressure;
extern osMutexId_t mutex_OD_OuttakePressure;
...
float OD_IntakePressure_get();
void OD_IntakePressure_set(const float value);

float OD_OuttakePressure_get();
void OD_OuttakePressure_set(const float value);
