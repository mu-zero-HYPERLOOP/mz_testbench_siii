  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    */
    GPIO_InitStruct.Pin = ADC_IN10_Board_Temp_Pin|LP9_sensing_Pin|ADC_IN12_Board_VCC_Pin|LP10_sensing_Pin
                          |HP1_sensing_Pin|HP4_sensing_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LP6_sensing_Pin|LP5_sensing_Pin|HP2_sensing_Pin|LP8_sensing_Pin
                          |LP7_sensing_Pin|LP2_sensing_Pin|LP1_sensing_Pin|HP3_sensing_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(GPIOC, ADC_IN10_Board_Temp_Pin|LP9_sensing_Pin|ADC_IN12_Board_VCC_Pin|LP10_sensing_Pin
                          |HP1_sensing_Pin|HP4_sensing_Pin);

    HAL_GPIO_DeInit(GPIOA, LP6_sensing_Pin|LP5_sensing_Pin|HP2_sensing_Pin|LP8_sensing_Pin
                          |LP7_sensing_Pin|LP2_sensing_Pin|LP1_sensing_Pin|HP3_sensing_Pin);

    HAL_GPIO_DeInit(GPIOB, LP4_sensing_Pin|LP3_sensing_Pin);
