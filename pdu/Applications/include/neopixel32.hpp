...
/**
 * Clock Frequency = 84MHz => X = 84MHz * 1300ns = 109.2 rouded down to 109. => Timer counts up to 108.
 */
#define NP32_WS2812_TIM_PERIOD 108
 ...
 */
/**
 * From the datasheet T0H = 400ns. Therefor nothing changes here.
 */
...
/**
 * From the datasheet
 * T1H = 800ns. 800ns of 1300ns -> 8/13 * 108 = 66.462 rouded down to 66. count up to 65
 */
#define NP32_WS2812_1_TIME              65U

/**
 * \brief The amount of zero-periods sent after the LED data as a reset command.
 */
/**
 * From the datasheet at least 50us.
 * One priod = 1.3us. 48 * 1.3us = 62.4us. Seems fine.
 */
